...
async function loadMedicamentosPorClinica(clinicaId) {
    ...
    try {
        //Traer solo el stock de esa clínica (ya filtra en el controlador)
        ...
        // Cargar datos de medicamentos y cachearlos por ID
        const medicamentos = {};
        ...
        //  agrupar por medicamentoId para no repetir filas
        const stockPorMed = {};
        for (const stock of stocks) {
            const medId = stock.medicamentoId;
